...
# ==================================================
# Link Hosting Kalian
wisnuvpn="raw.githubusercontent.com/samratui/Mantap/main/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/samratu/Mantap/main/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/samratu/Mantap/main/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/samratu/Mantap/main/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
